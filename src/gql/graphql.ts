...
export type ConnectionSources = MockConnection | PlaidConnection;
...
export type Mutation = {
  ...
  /** Force a connection into error state in non-production. */
